...
module.exports = async (req,res) => { const t=await requireAuth(req,res); if(!t)return; const repo=req.query.repo; if(!/^[^/]+\/[^/]+$/.test(repo||'')) return json(res,400,{error:'invalid_repo'}); try {
